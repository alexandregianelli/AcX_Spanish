...
from TextRepresentators.Representator_New_Locality import Representator_New_Locality, regex_word_tokenizer
import numpy as np
...
class Expander_New_Locality_Test(unittest.TestCase):
    ...
    def test_transform(self):
        ...
        rep = Representator_New_Locality(articlesDB,
        ...
        rep = Representator_New_Locality(trainInstanceArticles, 
                                         word_tokenizer = word_tokenizer, 
                                         vocabulary = vocabulary, 
                                         vectorizer = None, 
                                         sentenceDecay = self.sentenceDecay,
