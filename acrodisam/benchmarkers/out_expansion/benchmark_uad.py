"""
Runs Out Expansion benchmark for the MSH dataset
"""
import pickle
...
if __name__ == "__main__":
    ...
    experiment_name = UAD_DATASET  # pylint: disable=invalid-name
    ...
    benchmarker = Benchmarker(
        ...
        train_dataset_name=UAD_DATASET,
        out_expander_name=args.out_expander,
        out_expander_args=args.out_expander_args,
    )

    generatedFilesFolder = getDatasetGeneratedFilesPath(UAD_DATASET)
    if args.crossvalidation:
        FOLDS_NUM = 5
        foldsFilePath = (
